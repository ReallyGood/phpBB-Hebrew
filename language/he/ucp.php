...
$lang = array_merge($lang, array (
  ...
  'FIELD_TOO_SHORT' => 
  array (
    1 => 'השדה "%2$s" קצר מידי, נדרש לפחות תו %1$d.',
    2 => 'השדה "%2$s" קצר מידי, נדרשים לפחות %1$d תווים.',
  ),
  'FIELD_TOO_LONG' => 
  array (
    1 => 'השדה "%2$s" ארוך מידי, מותר לכל היותר תו %1$d.',
    2 => 'השדה "%2$s" ארוך מידי, מותרים לכל היותר %1$d תווים.',
  ),
  ...
  'NO_AUTH_PRINT_MESSAGE' => 'אינך מורשה להדפיס הודעות פרטיות.',
  ...
  'PASSWORD_RESET_LINK_SENT' => 'אם חשבונך קיים, קישור לאיפוס ססמה נשלח לכתובת הדוא״ל הרשומה שלך. אם לא קיבלת דוא״ל, ייתכן שהסיבה היא שאתה חסום, חשבונך לא הופעל, ביקשת מספר איפוסי ססמה בפרק זמן קצר, או שאינך מורשה לשנות את ססמתך. צור קשר עם מנהל ראשי אם אחת מהסיבות הללו רלוונטית. כמו כן, בדוק את מסנן דואר הזבל שלך.',
  ...
  'PM_FROM' => 'מאת',
  'PM_FROM_REMOVED_AUTHOR' => 'הודעה זו נשלחה על־ידי משתמש שאינו רשום יותר.',
