...
$lang = array_merge($lang, array(
	...
	'FOLDER_ADDED'				=> 'התיקייה נוספה בהצלחה.',
		...
		1	=> '%2$d מתוך %1$s אוחסנה',
		2	=> '%2$d מתוך %1$s אוחסנו',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'התיקייה %3$d%% מלאה (%2$d מתוך %1$s אוחסנה)',
		2	=> 'התיקייה %3$d%% מלאה (%2$d מתוך %1$s אוחסנו)',
	),
	...
	'LOGIN_LINK'					=> 'קשור או רשום את החשבון שלך עם שירות חיצוני בעזרת החשבון שלך במערכת הפורומים',
	'LOGIN_LINK_EXPLAIN'			=> 'ניסית להתחבר עם שירות חיצוני שעדיין לא חובר לחשבון במערכת פורומים זו. עליך לקשר את החשבון הזה לחשבון קיים או ליצור חשבון חדש.',
	...
	'LOGIN_KEY'						=> 'מפתח ההתחברות',
	'LOGIN_TIME'					=> 'זמן ההתחברות',
	...
	'NOTIFICATIONS_MARK_ALL_READ'						=> 'סמן את כל ההודעות כנקראו',
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> 'האם אתה בטוח שברצונך לסמן את כל ההודעות כנקראו?',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'				=> 'כל ההודעות סומנו כנקראו.',
	'NOTIFICATION_GROUP_MISCELLANEOUS'					=> 'הודעות שונות',
	'NOTIFICATION_GROUP_MODERATION'						=> 'התראות ניהול',
	'NOTIFICATION_GROUP_ADMINISTRATION'					=> 'התראות ניהול המערכת',
	'NOTIFICATION_GROUP_POSTING'						=> 'התראות הודעות',
	'NOTIFICATION_METHOD_EMAIL'							=> 'דואר אלקטרוני',
	'NOTIFICATION_METHOD_JABBER'						=> 'Jabber',
	'NOTIFICATION_TYPE'									=> 'סוג ההודעה',
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'מישהו מגיב לנושא שסימנת כמועדף',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'מישהו ביקש להצטרף לקבוצה שאתה מוביל',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> 'נושא או הודעה חדשים ממתינים לאישור',
	...
	'NOTIFICATION_TYPE_POST'							=> 'מישהו הגיב לנושא אליו נרשמת לקבלת עדכונים',
	...
	'PM_MARK_ALL_READ_SUCCESS'	=> 'כל ההודעות הפרטיות שבתיקיה הזו סומנו כהודעות שנקראו',
	...
	'UCP_NOTIFICATION_LIST'				=> 'נהל התראות',
	'UCP_NOTIFICATION_LIST_EXPLAIN'		=> 'כאן אתה יכול לצפות בכל ההתראות הקודמות.',
	'UCP_NOTIFICATION_OPTIONS'			=> 'שינוי הגדרות התראה',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'כאן אתה יכול להגדיר את אמצעי ההתראה המועדף עליך למערכת.',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'ניהול מפתחות התחברות "זכור אותי" אוטומטיים',
