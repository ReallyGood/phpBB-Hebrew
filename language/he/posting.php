...
$lang = array_merge($lang, array(
	...
	'ATTACH_COMMENT_NO_EMOJIS'	=> 'תיאור הקובץ המצורף כולל תווים אסורים (אימוג\'ים).',
	...
	'LOGIN_EXPLAIN_SOFT_DELETE'	=> 'עליך להיות מחובר על מנת לבצע מחיקה רכה של הודעות בפורום זה.',
	...
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'הגבלת זמן עבור נושאים דביקים/הכרזות/הכרזות גלובאליות',
	'STICK_TOPIC_FOR'			=> 'Stick topic for',
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'הזן 0 עבור נושא דביק/הכרזה/הכרזה גלובאלית ללא הגבלת זמן. יש לקחת בחשבון שמספר זה הינו יחסי לתאריך פרסום הנושא.',
