...
$lang = array_merge($lang, array (
  ...
  array (
    1 => 'מחק נושא זה לצמיתות כך שלא ניתן יהיה לשחזר אותו',
    2 => 'מחק %1$d נושאים לצמיתות כך שלא ניתן יהיה לשחזר אותם',
  ),
  'DELETE_TOPIC_PERMANENTLY_CONFIRM' => 'האם אתה בטוח שברצונך למחוק נושא זה <strong>לצמיתות</strong>?',
  'DELETE_TOPICS_CONFIRM' => 'האם אתה בטוח שברצונך למחוק נושאים אלו?',
  'DELETE_TOPICS_PERMANENTLY_CONFIRM' => 'האם אתה בטוח שברצונך למחוק נושאים אלו <strong>לצמיתות</strong>?',
  ...
  'NO_TEMP_DIR' => 'התיקייה הזמנית לא נמצאה או אינה ניתנת לכתיבה.',
  'PARTIAL_UPLOAD' => 'הקובץ הועלה באופן חלקי בלבד.',
  'PHP_UPLOAD_STOPPED' => 'תוסף PHP עצר את העלאת הקובץ.',
