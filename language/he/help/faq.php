...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_COPPA_QUESTION'	=> 'What is COPPA?',
 	'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'	=> '“מחיקת עוגיות” מוחק את כל העוגיות (cookies) שנוצרו על ידי phpBB ושומרות עליך מחובר למערכת. עוגיות ממלאות תפקידים נוספים כמו מעקב קריאה של נושאים והודעות אם האפשרות הופעלה על ידי מנהל ראשי. אם נתקלת בבעיות של התחברות והתנתקות, מחיקת עוגיות המערכת יכולה לעזור.',
 	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> 'מה האפשרות “מחיקת עוגיות” עושה ?',
