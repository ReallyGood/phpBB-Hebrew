...
$lang = array_merge($lang, array(
	...
	'CONFIRM_CODE_WRONG'	=> 'קוד האישור שהוזן שגוי.',
	'CONFIRM_OPERATION'		=> 'האם אתה בטוח שברצונך להמשיך?',
	'CONFIRM_AVATAR_DELETE' => 'אתה בטוח שאתה רוצה למחוק את האוואטר?',
	...
	'LEGEND'							=> 'מקרא',
	'LIVE_SEARCHES_NOT_ALLOWED'			=> 'חיפושים חיים לא מורשים.',
	'LOADING'							=> 'טוען',
	'LOCATION'							=> 'מיקום',
	'LOCK_POST'							=> 'נעל הודעה',
	...
	'MODERATOR'				=> 'מנהל',
	'MODERATORS'			=> 'המנהלים',
	'MODULE_NOT_ACCESS'		=> 'לא ניתן לגשת למודול',
	'MODULE_NOT_FIND'		=> 'המודול %s לא נמצא',
	'MODULE_FILE_INCORRECT_CLASS'	=> 'קובץ המודול %s לא כולל את המחלקה הנכונה [%s]',
	'MONTH'					=> 'חודש',
	'MOVE'					=> 'העבר',
	...
	'NOTIFICATION_POST_IN_QUEUE'		=> '<strong>בקשת אישור הודעה</strong> על ידי %1$s:',
	...
	'PLAY_QUICKTIME_FILE'	=> 'נגן קובץ Quicktime',
	...
	'POST_DISPLAY'			=> '%1$sהצג הודעה זו%2$s.',
	'POST_DAY'				=> '%.2f הודעות ליום',
	'POST_DELETED_ACTION'	=> 'הודעה שנמחקה:',
	'POST_DELETED'			=> 'ההודעה נמחקה.',
	'POST_DELETED_BY'		=> 'הפוסט מאת <strong>%1$s</strong> נמחק על ידי <strong>%2$s</strong> בתאריך %3$s.',
	'POST_DELETED_BY_REASON'=> 'הפוסט מאת <strong>%1$s</strong> נמחק על ידי y בתאריך <strong>%2$s</strong> מהסיבה הבאה: %3$s',
	...
	'TIB'				=> 'TiB',
	'TIME'			=> 'זמן',
	'TIMEOUT_PROCESSING_REQ'			=> 'עבר הזמן המוקצב לבקשה.',
	...
	'UNABLE_GET_IMAGE_SIZE'	=> 'לא ניתן היה לקבוע את מימדי התמונה, אנא ודא כי כתובת האינטרנט שהכנסת נכונה..',
