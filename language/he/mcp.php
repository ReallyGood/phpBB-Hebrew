...
$lang = array_merge($lang, array(
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'במילוי הטופס הנמצא מטה תוכל להעביר הודעות לנושא אחר. ההודעות יפוצלו מנושא זה וימוזגו לנושא אחר. סדר ההודעות לא ישתנה ויופיע כאילו שהמשתמשים פרסמו אותם בנושא חדש.<br />אנא בחר את מספר הזיהוי של הנושא או לחץ על “בחר נושא” בכדי לחפש את הנושא המבוקש.',
