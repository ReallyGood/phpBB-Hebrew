...
$lang = array_merge($lang, array (
  ...
  'DOWNLOAD_ADD_IPS_EXPLAIN' => 'כדי לציין מספר כתובות IP או שמות שרת שונים, הזן כל אחד בשורה חדשה. כדי לציין טווח כתובות IP, הפרד בין ההתחלה והסוף באמצעות מקף (-). כדי לציין תו כללי (wildcard), השתמש ב־“*”.',
  ...
  'FILES_GONE' => 'חלק מהקבצים המצורפים שבחרת למחיקה אינם קיימים. ייתכן שכבר נמחקו. הקבצים המצורפים שכן היו קיימים נמחקו.',
  'FILES_STATS_WRONG' => 'סטטיסטיקות הקבצים שלך כנראה אינן מדויקות ויש לסנכרן אותן מחדש. ערכים בפועל: מספר הקבצים המצורפים = %1$d, סך גודל הקבצים המצורפים = %2$s.<br />לחץ %3$sכאן%4$s כדי לסנכרן מחדש.',
  ...
  'IMAGE_QUALITY_EXPLAIN' => 'ציין ערך בין 50% (גודל קובץ קטן יותר) לבין 90% (איכות גבוהה יותר). איכות גבוהה מ־90% מגדילה את גודל הקובץ ולכן אינה זמינה. ההגדרה חלה רק אם ממדי התמונה המרביים נקבעו לערך שאינו 0px על 0px.',
  'IMAGE_STRIP_METADATA' => 'הסר מטא־דאטה מהתמונה (JPEG בלבד)',
  'IMAGE_STRIP_METADATA_EXPLAIN' => 'הסר מטא־דאטה מסוג Exif, למשל שם המחבר, קואורדינטות GPS ופרטי המצלמה. ההגדרה חלה רק אם ממדי התמונה המרביים נקבעו לערך שאינו 0px על 0px.',
  ...
  'NO_EXT_GROUP' => 'ללא',
  'NO_EXT_GROUP_ALLOWED_PM' => 'אין <a href="%s">קבוצות סיומות מורשות</a> להודעות פרטיות.',
  'NO_EXT_GROUP_ALLOWED_POST' => 'אין <a href="%s">קבוצות סיומות מורשות</a> להודעות.',
  ...
  'UPLOAD_POST_NOT_EXIST' => 'לא ניתן להעלות את הקובץ “%1$s” להודעה מספר %2$d מאחר שההודעה אינה קיימת.',
));
