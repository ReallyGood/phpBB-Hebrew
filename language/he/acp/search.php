...
$lang = array_merge($lang, array (
  ...
  'DEFAULT_SEARCH_RETURN_CHARS_EXPLAIN' => 'מספר ברירת המחדל של התווים שיוחזרו בעת חיפוש. ערך של 0 יחזיר את ההודעה כולה.',
  ...
  array (
    2 => 'כל ההודעות עד מזהה הודעה %2$d אוגרו כעת, מתוכן %1$d הודעות בשלב זה.<br />',
  ),
  'SEARCH_INDEX_CREATE_REDIRECT_RATE' => 
  array (
    2 => 'קצב האגירה הנוכחי הוא כ־%1$.1f הודעות לשנייה.<br />אגירה בביצוע…',
  ),
  'SEARCH_INDEX_DELETE_REDIRECT' => 
  array (
    2 => 'כל ההודעות עד מזהה הודעה %2$d הוסרו ממאגר החיפוש, מתוכן %1$d הודעות בשלב זה.<br />',
  ),
  'SEARCH_INDEX_DELETE_REDIRECT_RATE' => 
  array (
    2 => 'קצב המחיקה הנוכחי הוא כ־%1$.1f הודעות לשנייה.<br />מחיקה בביצוע…',
  ),
  'SEARCH_INDEX_CREATED' => 'כל ההודעות במסד הנתונים של המערכת אוגרו בהצלחה.',
  'SEARCH_INDEX_PROGRESS' => 'Done: %1$d | Pending: %2$d | Total: %3$d',
  'SEARCH_INDEX_REMOVED' => 'מאגר החיפוש של מנוע זה נמחק בהצלחה.',
  'SEARCH_INTERVAL' => 'השהיית הצפת חיפושים למשתמש',
  'SEARCH_INTERVAL_EXPLAIN' => 'מספר השניות שמשתמשים חייבים להמתין בין חיפושים. ההשהיה נבדקת בנפרד עבור כל משתמש.',
  'SEARCH_STORE_RESULTS' => 'משך שמירת תוצאות חיפוש במטמון',
  'SEARCH_STORE_RESULTS_EXPLAIN' => 'תוצאות חיפוש השמורות במטמון יפוגו לאחר זמן זה, בשניות. קבע 0 כדי לבטל את מטמון החיפוש.',
  'SEARCH_TYPE' => 'מנוע חיפוש',
  'SEARCH_TYPE_EXPLAIN' => 'phpBB מאפשרת לבחור את מנוע החיפוש המשמש לחיפוש טקסט בתוכן ההודעות. כברירת מחדל נעשה שימוש במנוע החיפוש המלא המובנה של phpBB.',
  'SWITCHED_SEARCH_BACKEND' => 'החלפת את מנוע החיפוש. כדי להשתמש במנוע החיפוש החדש, יש לוודא שקיים מאגר עבור המנוע שנבחר.',
  'TOTAL_WORDS' => 'מספר כולל של מילים שאוגרו',
  'TOTAL_MATCHES' => 'מספר כולל של קשרי מילה־להודעה שאוגרו',
  'YES_SEARCH' => 'אפשר יכולות חיפוש',
  'YES_SEARCH_EXPLAIN' => 'מאפשר פונקציונליות חיפוש למשתמשים, כולל חיפוש חברים.',
  'YES_SEARCH_UPDATE' => 'אפשר עדכון חיפוש טקסט מלא',
  'YES_SEARCH_UPDATE_EXPLAIN' => 'עדכון מאגרי טקסט מלא בעת פרסום הודעות; מבוטל אם החיפוש מושבת.',
));
