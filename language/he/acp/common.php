...
$lang = array_merge($lang, array (
  ...
  'CRON_LOCK_ERROR' => 'לא ניתן היה להשיג נעילת cron.',
  'CRON_NO_SUCH_TASK' => 'לא ניתן למצוא את משימת ה-cron "%s".',
  'CRON_NO_TASK' => 'אין משימות cron שצריכות לרוץ כרגע.',
  'CRON_NO_TASKS' => 'לא נמצאו משימות cron.',
  'CSV_INVALID' => 'ההגדרה המופרדת בפסיקים "%1$s" שסופקה אינה תקינה. הערכים צריכים להיות מופרדים בפסיק בלבד, ללא מפריד מוביל או נגרר.',
  ...
  'URL_SCHEME_INVALID' => 'הסכמה "%2$s" שסופקה בהגדרה המופרדת בפסיקים "%1$s" אינה תקינה. הסכמה צריכה להתחיל בתו לטיני ואחריו תווים אלפאנומריים, מקפים או נקודות.',
  ...
  'ERROR_DEFAULT_CHARSET' => 'ערכת התווים המוגדרת כברירת מחדל הוגדרה לא נכון',
  'ERROR_DEFAULT_CHARSET_EXPLAIN' => '<var>default_charset</var> חייב להיות מוגדר ל־<samp>UTF-8</samp>. אתה יכול לבדוק את הערך הנוכחי בעמוד <samp>פרטי PHP</samp>.',
  ...
  'LOG_SPAMHAUS_OPEN_RESOLVER' => 'Spamhaus אינו מאפשר שאילתות באמצעות resolver פתוח. בדיקת רשימה שחורה הושבתה. למידע נוסף, ראה https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
  'LOG_SPAMHAUS_VOLUME_LIMIT' => 'מכסת השאילתות של Spamhaus חרגה. בדיקת רשימה שחורה הושבתה. למידע נוסף, ראה https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
  ...
  array (
    1 => '<strong>מחק אזהרת משתמש</strong><br />» %1$s',
    2 => '<strong>מחק %2$d אזהרות משתמש</strong><br />» %1$s',
  ),
  'LOG_WARNINGS_DELETED_ALL' => '<strong>מחק את כל אזהרות המשתמש</strong><br />» %s',
  'LOG_WORD_ADD' => '<strong>הוסיף צנזור מילה</strong><br />» %s',
  'LOG_WORD_DELETE' => '<strong>מחק צנזור מילה</strong><br />» %s',
  'LOG_WORD_EDIT' => '<strong>ערך צנזור מילה</strong><br />» %s',
  'LOG_EXT_ENABLE' => '<strong>תוספת הופעלה</strong><br />» %s',
  'LOG_EXT_DISABLE' => '<strong>תוספת הושבתה</strong><br />» %s',
  'LOG_EXT_PURGE' => '<strong>נתוני תוספת נמחקו</strong><br />» %s',
  'LOG_EXT_UPDATE' => '<strong>תוספת עודכנה</strong><br />» %s',
));
