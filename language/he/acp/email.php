...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> 'כאן תוכל לשלוח הודעת דואר אלקטרוני לכל המשתמשים או לכל המשתמשים מקבוצה מסוימת <strong>אשר בעלי האפשרות לקבל הודעות משולח הדואר פעילה</strong>. על מנת לבצע זאת, הודעה תשלח לכתובת הדואר האלקטרוני של המנהל הראשי שסופקה, עם העתק חסוי הנשלח לכל הנמענים. ההגדרה כברירת מחדל היא לכלול 50 נמענים עבור הודעה אחת, ולנמענים נוספים הודעות ניוספות ישלחו. אם אתה שולח לקבוצה גדולה של אנשים אנא המתן בסבלנות לאחר השליחה ואל תעצור את העמוד באמצע הפעולה. שליחת דואר אשר לוקחת זמן רב הינה דבר נורמלי, אתה תקבל הודעה כאשר הפעולה תושלם.',
