...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'המערכת תהיה לא זמינה למשתמשים אשר אינם מנהלים ראשיים או חברי צוות. תוכל גם להזין הודעה קצרה (255 תווים) התוצג אם תרצה.',
...
$lang = array_merge($lang, array(
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'נתיב תחת תיקיית המערכת של phpBB3, למשל <samp>images/avatars/upload</samp>.<br />העלת סמלים אישיים <strong>לא תיהיה זמינה</strong> אם התיקיה לא ניתנת לכתיבה.',
