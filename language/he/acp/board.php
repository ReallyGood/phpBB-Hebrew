...
$lang = array_merge($lang, array (
  ...
  'ALLOW_GRAVATAR' => 'אפשר סמלי Gravatar',
  ...
  'AVATAR_GALLERY_PATH_EXPLAIN' => 'נתיב תחת תיקיית המערכת של phpBB3 לגלריית הסמלים האישיים, למשל <samp>images/avatars/gallery</samp>.<br>נקודות כפולות כמו <samp>../</samp> יוסרו מהנתיב מטעמי אבטחה.',
  ...
  'ALLOWED_SCHEMES_LINKS' => 'סכמות מורשות בקישורים',
  'ALLOWED_SCHEMES_LINKS_EXPLAIN' => 'משתמשים יכולים לפרסם רק כתובות ללא סכימה (schemeless) או אחת מהסכמות המורשות המופרדות בפסיקים.',
  ...
  'ACC_ACTIVATION_WARNING' => 'שים לב: שיטת ההפעלה שנבחרה כעת מחייבת שהודעות דוא״ל יהיו מופעלות, אחרת ההרשמה תושבת. מומלץ לבחור שיטת הפעלה אחרת או להפעיל מחדש את הדוא״ל.',
  ...
  'COOKIE_PATH_EXPLAIN' => 'שים לב: זה תמיד לוכסן (/), ללא קשר לכתובת (URL) של המערכת.',
  ...
  'EMAIL_FORCE_SENDER_EXPLAIN' => 'הגדרה זו תקבע את <samp>Return-Path</samp> לכתובת ה״מאת״ (From) במקום להשתמש במשתמש המקומי ובשם המארח של השרת. הגדרה זו אינה חלה בעת שימוש ב־SMTP.<br><em><strong>אזהרה:</strong> דורש שהמשתמש תחתיו רץ שרת הווב יוגדר כמשתמש מהימן (trusted) בתצורת sendmail.</em>',
  ...
  'SMTP_ALLOW_SELF_SIGNED' => 'אפשר תעודות SSL בחתימה עצמית',
  'SMTP_ALLOW_SELF_SIGNED_EXPLAIN' => 'אפשר להתחבר לשרת SMTP באמצעות תעודת SSL בחתימה עצמית.<em><strong>אזהרה:</strong> אפשרות זו עלולה לגרום להשלכות אבטחה.</em>',
  ...
  'SMTP_VERIFY_PEER_EXPLAIN' => 'דרוש אימות של תעודת ה־SSL שבה משתמש שרת ה־SMTP.<br><em><strong>אזהרה:</strong> התחברות ליעדים עם תעודות SSL לא מאומתות עלולה לגרום להשלכות אבטחה.</em>',
  'SMTP_VERIFY_PEER_NAME' => 'אימות שם היעד (peer) ב־SMTP',
  'SMTP_VERIFY_PEER_NAME_EXPLAIN' => 'דרוש אימות של שם היעד (peer) עבור שרתי SMTP המשתמשים בחיבורי SSL/TLS.<br><em><strong>אזהרה:</strong> התחברות ליעדים לא מאומתים עלולה לגרום להשלכות אבטחה.</em>',
  ...
  'JAB_ALLOW_SELF_SIGNED' => 'אפשר תעודות SSL בחתימה עצמית',
  'JAB_ALLOW_SELF_SIGNED_EXPLAIN' => 'אפשר להתחבר לשרת Jabber באמצעות תעודת SSL בחתימה עצמית.<em><strong>אזהרה:</strong> אפשרות זו עלולה לגרום להשלכות אבטחה.</em>',
  ...
  'JAB_VERIFY_PEER' => 'אמת תעודת SSL',
  'JAB_VERIFY_PEER_EXPLAIN' => 'דרוש אימות של תעודת ה־SSL שבה משתמש שרת ה־Jabber.<em><strong>אזהרה:</strong> התחברות ליעדים עם תעודות SSL לא מאומתות עלולה לגרום להשלכות אבטחה.</em>',
  'JAB_VERIFY_PEER_NAME' => 'אמת את שם היעד (peer) של Jabber',
  'JAB_VERIFY_PEER_NAME_EXPLAIN' => 'דרוש אימות של שם היעד (peer) עבור שרתי Jabber המשתמשים בחיבורי SSL/TLS.<em><strong>אזהרה:</strong> התחברות ליעדים לא מאומתים עלולה לגרום להשלכות אבטחה.</em>',
));
