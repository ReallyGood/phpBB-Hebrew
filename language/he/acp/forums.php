...
$lang = array_merge($lang, array (
  ...
  'LIMIT_SUBFORUMS_EXPLAIN' => 'מגביל את תתי הפורומים המוצגים לתתי פורומים שהם צאצאים ישירים (בנים) של הפורום הנוכחי. ביטול אפשרות זו יציג את כל תתי הפורומים עם האפשרות "רשום תת פורום ברשימה" מופעלת, ללא קשר לעומק.',
