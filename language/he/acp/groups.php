...
$lang = array_merge($lang, array(
	...
	'GROUP_EDIT_EXPLAIN'			=> 'כאן אתה יכול לערוך קבוצות קיימות. אתה יכול לשנות את שמם, תיאורם וסוגם (פתוח, סגור, וכדומה..). אתה יכול להגדיר את גודל הקבוצה או צבע, דירוג, ואפשרויות נוספות השינויים שיבוצעו כאן יעקפו את הגדרות המשתמשים שנמצאים בקבוצה. שים לב חברי הקבוצה יכולים לערוך את סמלם האישי רק אם כן הגדרת הרשאות משתמש תואמים.',
	...
	'GROUP_MESSAGE_LIMIT'			=> 'ההודעות הפרטיות של הקבוצה מוגבלות בתיקייה אחת',
	...
	'GROUP_MAX_RECIPIENTS'			=> 'מספר מרבי של נמענים מורשים לכל הודעה פרטית',
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'המספר המרבי של נמענים המורשים בהודעה פרטית.קבע ערך זה ל־0 על מנת שהגדרות המערכת יהיו בשימוש.',
	...
	'TEAMPAGE_EXPLAIN'				=> 'אלו הן הקבוצות המוצגות בעמוד הצוות:',
	'TEAMPAGE_FORUMS'				=> 'הצג את הפורומים המנוהלים',
	'TEAMPAGE_FORUMS_EXPLAIN'		=> 'אם מופעל, מתחת לכל שורה של מנהל תהיה רשימה של כל הפורומים בהם יש לו הרשאות ניהול. למערכות גדולות הדבר עלול לגזול משאבים רבים.',
	'TEAMPAGE_MEMBERSHIPS'			=> 'הצג את שיוכו לקבוצות של המשתמש ',
	'TEAMPAGE_SETTINGS'				=> 'הגדרות עמוד צוות',
