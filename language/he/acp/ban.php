...
$lang = array_merge($lang, array (
  ...
  'BANNED_UNTIL_DATE' => 'עד %s',
  'BANNED_UNTIL_DURATION' => '%1$s (עד %2$s)',
  ...
  'IP_BAN_EXPLAIN' => 'כדי לציין מספר כתובות IP או שמות שרתים שונים, הזן כל אחד בשורה חדשה. כדי לציין טווח כתובות IP, הפרד בין ההתחלה לסוף באמצעות מקף (-), כדי לציין תו כללי השתמש ב-"*".',
