...
$lang = array_merge($lang, array(
	...
	'INITIAL_CONFIG_EXPLAIN'	=> 'כעת לאחר שהתקנת phpBB3.1 הסתיימה, אתה צריך לספק כמה פרטים. אם אינך יודע כיצד להתחבר לבסיס הנתונים שלך, צור קשר עם ספק האחסון שלך (בשלב הראשון) או השתמש בפורומי התמיכה של phpBB. בעת הזנת הפרטים וודא שאתה בודק אותם ביסודיות לפני שתמשיך.',
...
$lang = array_merge($lang, array(
	...
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'הגרסה המותקנת של phpBB3 אינה עדכנית.',
	'VERSION_UP_TO_DATE'		=> 'הגרסה המותקנת של phpBB3 עדכנית. למרות שאין עדכונים זמינים כרגע, ניתן להמשיך כדי לבצע בדיקת חוקיות.',
	'VERSION_UP_TO_DATE_ACP'	=> 'הגרסה המותקנת של phpBB3 עדכנית. אין עדכונים זמינים כעת.',
