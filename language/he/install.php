...
$lang = array_merge($lang, array (
  ...
  'INTRODUCTION_BODY'		=> 'ברוך הבא ל־phpBB3!<br /><br />phpBB® היא מערכת לוחות דיונים בקוד פתוח הנפוצה ביותר בעולם. phpBB3 היא הגרסה העדכנית בסדרת גרסאות שהחלה בשנת 2000. כמו קודמותיה, phpBB3 עשירה בתכונות, ידידותית למשתמש, וזוכה לתמיכה מלאה מצוות phpBB. phpBB3 משפרת משמעותית את מה שהפך את phpBB2 לפופולרית, ומוסיפה תכונות נפוצות שהתבקשו ולא היו קיימות בגרסאות קודמות. אנו מקווים שהיא תעלה על ציפיותיך.<br /><br />מערכת ההתקנה תדריך אותך בהתקנת phpBB3, בעדכון לגרסה העדכנית מתוך גרסאות קודמות, וכן בהמרה ל־phpBB3 ממערכת דיונים אחרת (כולל phpBB2). למידע נוסף אנו ממליצים לקרוא את <a href="%1$s">מדריך ההתקנה</a>.<br /><br />כדי לקרוא את רישיון phpBB3 או ללמוד על קבלת תמיכה והמדיניות שלנו בנושא, בחר באפשרויות המתאימות בתפריט הצד. כדי להמשיך, בחר בלשונית המתאימה למעלה.',
  'SUPPORT_TITLE' => 'תמיכה',
  'SUPPORT_BODY'		=> 'תמיכה מלאה תינתן עבור הגרסה היציבה הנוכחית של phpBB3, ללא תשלום. זה כולל:</p><ul><li>התקנה</li><li>הגדרה (configuration)</li><li>שאלות טכניות</li><li>בעיות הקשורות לבאגים אפשריים בתוכנה</li><li>עדכון מגרסאות Release Candidate (RC) לגרסה היציבה העדכנית</li><li>המרה מ־phpBB 2.0.x ל־phpBB3</li><li>המרה מתוכנות לוחות דיונים אחרות ל־phpBB3 (ראה את <a href="https://www.phpbb.com/community/viewforum.php?f=486">פורום ההמרות</a>)</li></ul><p>אנו ממליצים למשתמשים שעדיין מריצים גרסאות בטא של phpBB3 להחליף את ההתקנה בעותק נקי של הגרסה העדכנית.</p><h2>תוספים / סגנונות</h2><p>לבעיות הקשורות לתוספים (Extensions), פרסם בפורום המתאים <a href="https://www.phpbb.com/community/viewforum.php?f=451">Extensions Forum</a>.<br />לבעיות הקשורות לסגנונות, תבניות וערכות נושא, פרסם בפורום המתאים <a href="https://www.phpbb.com/community/viewforum.php?f=471">Styles Forum</a>.<br /><br />אם השאלה שלך קשורה לחבילה מסוימת, פרסם ישירות בנושא המוקדש לחבילה.</p><h2>קבלת תמיכה</h2><p><a href="https://www.phpbb.com/support/">אזור התמיכה</a><br /><a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/">מדריך התחלה מהירה</a><br /><br />כדי להישאר מעודכן בחדשות ובשחרורים האחרונים, עקוב אחרינו ב־<a href="https://www.twitter.com/phpbb/">Twitter</a> וב־<a href="https://www.facebook.com/phpbb/">Facebook</a><br /><br />',
  'LICENSE_TITLE' => 'רשיון פומבי כללי',
  'INSTALL_INTRO' => 'ברוך הבא להתקנה',
  'INSTALL_INTRO_BODY'	=> 'באפשרות זו ניתן להתקין את phpBB3 על השרת שלך.</p><p>כדי להמשיך, תזדקק להגדרות מסד הנתונים שלך. אם אינך יודע מהן, פנה לספק האחסון ובקש אותן. לא תוכל להמשיך ללא הגדרות אלו. תזדקק ל:</p>

	<ul>
		<li>סוג בסיס הנתונים – בסיס הנתונים שבו תשתמש.</li>
		<li>שם מארח (hostname) של שרת בסיס הנתונים או DSN – הכתובת של שרת בסיס הנתונים.</li>
		<li>פורט של שרת בסיס הנתונים – הפורט של שרת בסיס הנתונים (ברוב המקרים אין בכך צורך).</li>
		<li>שם בסיס הנתונים – שם בסיס הנתונים בשרת.</li>
		<li>שם משתמש וססמה לבסיס הנתונים – פרטי ההתחברות לגישה לבסיס הנתונים.</li>
	</ul>

	<p><strong>הערה:</strong> אם אתה מתקין באמצעות SQLite, הזן בשדה ה־DSN את הנתיב המלא לקובץ בסיס הנתונים שלך והשאר את שדות שם המשתמש והססמה ריקים. מטעמי אבטחה, ודא שקובץ בסיס הנתונים אינו מאוחסן במיקום שנגיש מהאינטרנט.</p>

	<p>phpBB3 תומכת בבסיסי הנתונים הבאים:</p>
	<ul>
		<li>MySQL 4.1.3 ומעלה (נדרשת MySQLi)</li>
		<li>PostgreSQL 8.3+</li>
		<li>SQLite 3.6.15+</li>
		<li>MS SQL Server 2000 ומעלה (ישירות או דרך ODBC)</li>
		<li>MS SQL Server 2005 ומעלה (Native)</li>
		<li>Oracle</li>
	</ul>

	<p>רק בסיסי הנתונים הנתמכים בשרת שלך יוצגו כאן.',
  ...
  'UPDATE_INSTALLATION_EXPLAIN'	=> 'באפשרות זו ניתן לעדכן את התקנת phpBB שלך לגרסה העדכנית.<br />במהלך התהליך כל הקבצים שלך ייבדקו לצורך אימות שלמותם. לפני העדכון תוכל לסקור את כל ההבדלים והקבצים.<br /><br />את עדכון הקבצים עצמו ניתן לבצע בשתי דרכים שונות.</p><h2>עדכון ידני</h2><p>בשיטה זו אתה מוריד רק את חבילת הקבצים שהשתנו הרלוונטית עבורך, כדי לוודא שלא תאבד שינויים שביצעת בקבצים. לאחר הורדת החבילה עליך להעלות ידנית את הקבצים למיקומם הנכון תחת ספריית הבסיס של phpBB. לאחר מכן תוכל להריץ שוב את שלב בדיקת הקבצים כדי לוודא שהעלית אותם למיקום הנכון.</p><h2>עדכון מתקדם באמצעות FTP</h2><p>שיטה זו דומה לראשונה אך ללא צורך להוריד ולהעלות את הקבצים בעצמך — הפעולות יבוצעו עבורך. כדי להשתמש בשיטה זו עליך לדעת את פרטי ההתחברות שלך ל־FTP, מאחר שתתבקש להזין אותם. בסיום תופנה שוב לבדיקה כדי לוודא שהכול עודכן כראוי.<br /><br />',
  'UPDATE_INSTRUCTIONS' => '
		<h1>הכרזת שחרור</h1>
