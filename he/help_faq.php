...
$help = array(
	...
	array(
		...
		1 => 'אינך חייב, זה תלוי במנהלי המערכת והרשאותיהם בפורום, יתכן ותהייה חייב להירשם בכדי לשלוח הודעות בפורום. בכל מקרה; הרישום יתן לך גישה לכלים אשר יעזרו וישפרו לך את חווית הגלישה בפורום דבר אשר לא תקבל כאורח, כלים כמו רישום ומעקב אחר נושאים, סמל אישי, חתימה, עריכת פרופיל משתמש ועוד. הרישום הנו לוקח דקות ספורות בלבד, כך שכדאי לך להרשם.'
	),
	array(
	...
	array(
		...
		1 => 'כדי לשלוח נושא חדש בפורום, לחץ על הכפתור הדרוש במסכי הפורום או הנושא. יתכן ותצטרך להירשם לפני שתוכל לשלוח הודעה. רשימת ההרשאות שלך בכל פורום זמינה בתחתית מסכי הפורום והנושא. לדוגמה: אתה יכול לשלוח נושאים חדשים, אתה יכול להצביע בסקרים, וכד\'.'
	),
	array(
	...
	array(
		...
		1 => 'כדי להירשם לפורום מסויים, לחץ על הקישור “הרשם לקבלת עדכונים מפורום זה” לאחר הכניסה לפורום. כדי להירשם לנושא, הגב לנושא עם תיבת הסימון להרשמה מסומנת או לחץ על הקישור “הרשם לקבלת עדכונים מנושא זה” בנושא עצמו.'
	),
	array(
