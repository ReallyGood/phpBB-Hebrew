...
$help = array(
	...
	array(
		...
		1 => 'המערכת נכתבה וקיבלה רישיון על ידי קבוצת phpBB. אם אתה רואה שיש אפשרות שלא קיימת ותועיל מאוד, או אם אתה מעוניין לדווח על תקלה, אנא בקר <a href="http://area51.phpbb.com/">באתר הפיתוח</a> של phpbb.com ותמצא את כל הכלים לעשות זאת.'
	),
	array(
