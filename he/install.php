...
$lang = array_merge($lang, array(
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'העלאת FTP לקבצים מצורפים פעילה בפורום הישן. כבה את אפשרות העלאת FTP וודא שתיקיית העלאה חוקית צוינה, ולאחר מכן העתק את כל הקבצים המצורפים לתיקיה הנגישה לרשת החדשה הזו. לאחר שביצעת זאת, התחל מחדש את ההמרה.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'כל הקבצים מעודכנים לגרסה האחרונה של phpBB. אתה צריך כעת <a href="../ucp.php?mode=login">להתחבר לפורום שלך</a> ולבדוק אם הכל עובד כשורה. אל תשכח למחוק, לשנות שם או להעביר את תיקיית ההתקנה! אנא שלח לנו מידע מעודכן על הגדרות השרת והמערכת מעמוד <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">מידע סטטיסטי</a> בלוח הבקרה למנהלים ראשיים.',
	...
	'COMPLETE_LOGIN_TO_BOARD'		=> 'אתה צריך כעת <a href="../ucp.php?mode=login">להתחבר לפורום שלך</a> ולבדוק שהכל עובד כשורה. אל תשכח למחוק, לשנות שם או להעביר את תיקיית ההתקנה!',
	...
	'FILES_NEW_EXPLAIN'				=> 'הקבצים הבאים אינם קיימים כרגע בתיקיית ההתקן שלך. קבצים אלה יתווספו לתיקיה זו.',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			...
			<li>העלה את התיקיה install השלמה הלא דחוסה לתיקיית המערכת של phpBB3 (היכן שנמצא הקובץ config.php).<br /><br /></li>
		</ul>
