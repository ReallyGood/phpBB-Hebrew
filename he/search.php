...
$lang = array_merge($lang, array(
	...
	'SEARCH_KEYWORDS_EXPLAIN'	=> 'הצב <strong>+</strong> לפני ביטוי שחייב להימצא ולהכלל בתוצאות החיפוש שלך, או <strong>-</strong> לפני ביטוי שלא חייב. תוכל גם לרשום רשימת ביטויים מופרדים ב־<strong>|</strong> וכל התאמה מאחד הביטויים יוצג לך בתוצאות החיפוש. השתמש ב־* (כוכבית) כתו משלים.',	
