...
$lang = array_merge($lang, array(
	...
	<br />
	המידע שלך נאסף בעזרת שתי דרכים. ראשונה, הגלישה אל “%1$s” תגרום למערכת phpBB ליצור מספר של עוגיות, אשר הם קבצי טקסט קטנים אשר מאוחסנים בתיקיית הקבצים הזמניים של דפדפן האינטרנט של המחשב שלך. שתי העוגיות הראשונות מכילות רק זיהות משתמש (להלן “זיהוי משתמש”) וזיהוי חיבור אנונימי (להלן “זיהוי חיבור”), הנקבעים אצל באופן אוטומטי על־ידי מערכת phpBB. עוגיה שלישית תיווצר לאחר שעיינת בנושאים ב־“%1$s” ובשימוש כדי לסמן את הנושאים אשר נקראו, כדי לשפר את הנאת השימוש.<br />
	<br />
	...
	<br />
	החשבון שלך יהיה בחשיפה מינימלית המכיל שם זיהוי ייחודי (להלן “שם המשתמש שלך”), ססמה אישית אשר בשימוש להתחברות לחשבון שלך (להלן “הססמה שלך”) וכתובת דואר אלקטרוני אישית וחוקית (להלן “הדואר האלקטרוני שלך”). המידע שלך לחשבון שלך ב־“%1$s” מוגן על־ידי חוקי הגנת נתונים המיושמים במדינה אשר מאחסנת אותנו. כל מידע מעבר לשם המשתמש שלך, הססמה שלך וכתובת הדואר האלקטרוני שלך הנדרש על־ידי “%1$s” במשך תהליך ההרשמה הינו חובה או רשות, לפי ההחלטה של “%1$s”. בכל המקרים, יש לך את האפשרות של איזה מידע בחשבונך יוצג לציבור. יותך מכך, בתוך החשבון שלך, יש לך את האפשרות לבחור או לבטל הודעות דואר אלקטרוני אשר נוצרות באופן אוטומטי על־ידי מערכת phpBB.<br />
	<br />
	הססמה שלך מוצפנת (הצפנה לכיוון אחד) כך שהיא מאובטחת. עם זאת, מומלץ שאתה לא תבצע שימוש חוזר באותה הססמה במספר אתרים שונים. הססמה שלך היא האמצעי לגישה לחשבון שלך ב־“%1$s”, אז אנא שמור עליה בבטחה ותחת שום מצב שבו מישהו הקשור ל־“%1$s”, phpBB או כל צד שלישי אחר, יבקש את סיסמתך בדרך לא חוקית. במידה ותשכח את הססמה שלך לחשבון שלך, תוכל להשתמש במאפיין “שכחתי את סיסמתי” המסופק על־ידי מערכת phpBB. תהליך זה יבקש ממך להזין את שם המשתמש שלך והדואר האלקטרוני שלך, לאחר מכן מערכת phpBB תיצור ססמה חדשה כדי להשיב את חשבונך.<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'CANNOT_MOVE_TO_SAME_FOLDER'=> 'לא ניתן להעביר הודעות אל התיקייה אשר אתה מעונין למחוק.',
	...
	'CURRENT_CHANGE_PASSWORD_EXPLAIN'	=> 'על מנת לשנות את סיסמתך, כתובת הדואר האלקטרוני שלך, או שם המשתמש שלך, אתה חייב להזין את סיסמתך הנוכחית.',
	'CUR_PASSWORD_EMPTY'		=> 'לא הזנת את הסיסמא הנוכחית.',
	...
	'SAME_PASSWORD_ERROR'		=> 'הססמה החדשה שהזנת זהה לסיסמתך הנוכחית.',
	...
	'TOO_MANY_REGISTERS'		=> 'עברת את המספר המרבי של נסיונות הרשמה לחיבור זה. נסה שנית מאוחר יותר.',
