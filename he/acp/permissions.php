...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>הן בשימוש לשליטה בהרשאה ברמה גלובלית ושייכות למערכת הפורום בשלמותה. הן בנוסף מתחלקות להרשאות של משתמש, הרשאות של קבוצה, מנהלים ראשיים ומנהלים גלובלים.</p>
		...
		<h2>משימות הרשאה</h2>
		<p>הן בשימוש לצפייה בהרשאות הפעילות אשר נקבעו למשתמשים, מנהלים (מקומיים וגלובלים), מנהלים ראשיים או פורומים.</p>
	...
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'כאן אתה יכול לקבוע משתמשים וקבוצות בתור מנהלי פורומים. כדי לקבוע למשתמשים הרשאה לפורומים, להגדיר הרשאות ניהול גלובלי או מנהלים ראשיים השתמש בעמוד המתאים.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'כאן אתה יכול לקבוע הרשאות מנהל גלובלי למשתמשים או קבוצות. מנהלים אלו הם כמו מנהלים רגילים אך להם יש הרשאה לכל הפורומים במערכת.',
	'ACP_GROUPS_FORUM_PERMISSIONS_EXPLAIN'		=> 'כאן אתה יכול לקבוע הרשאות פורום לקבוצות.',
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'כאן אתה יכול לקבוע הרשאות גלובליות לקבוצות – הרשאות משתמש, הרשאות מנהל גלובלי והרשאות מנהל ראשי. הרשאות משתמש כוללות יכולות כמו שימוש בסמלים אישיים, שליחת הודעות פרטות, וכדומה. הרשאות מנהל גלובלי כוללות יכולות כמו אישות הודעות, ניהול נושאים, ניהול חסימות, וכדומה, ולבסוף הרשאות מנהל ראשי כוללות יכולות כמו שינוי הרשאות, הגדרת תגי BBCode מותאמים אישית, ניהול פורומים, וכדומה. הרשאות משתמש יחיד מומלץ לשנות במקרים נדירים, השיטה המועדפת היא הכנסת משתמשים לקבוצות וקביעת הרשאות לקבוצה.',
	...
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'כאן אתה יכול לקבוע הרשאות גלובליות למשתמשים – הרשאות משתמש, הרשאות מנהל גלובלי והרשאות מנהל ראשי. הרשאות משתמש כוללות יכולות כמו שימוש בסמלים אישיים, שליחת הודעות פרטות, וכדומה. הרשאות מנהל גלובלי כוללות יכולות כמו אישות הודעות, ניהול נושאים, ניהול חסימות, וכדומה, ולבסוף הרשאות מנהל ראשי כוללות יכולות כמו שינוי הרשאות, הגדרת תגי BBCode מותאמים אישית, ניהול פורומים, וכדומה. הרשאות משתמש יחיד מומלץ לשנות במקרים נדירים, השיטה המועדפת היא הכנסת משתמשים לקבוצות וקביעת הרשאות לקבוצה.',
