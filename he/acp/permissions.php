...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>הן בשימוש לשליטה בהרשאה ברמה גלובאלית ושייכות למערכת הפורום בשלמותה. הן בנוסף מתחלקות להרשאות של משתמשים, הרשאות של קבוצות, מנהלים ראשיים ומנהלים גלובאלים.</p>

		<h2>הרשאות לפי פורומים</h2>
		<p>הן בשימוש לשליטה בהרשאה בכל פורום. הן בנוסף נחלקות להרשאות פורום, מנהלי פורום, הרשאות פורום של משתמשים והרשאות פורום של קבוצות.</p>
	...
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'כאן אתה יכול לקבוע הרשאות גלובאליות למשתמשים - הרשאות משתמש, הרשאות מנהל גלובאלי והרשאות מנהל ראשי. הרשאות משתמש כוללות יכולות כמו שימוש בסמלים אישיים, שליחת הודעות פרטות, וכדומה. הרשאות מנהל גלובאלי כוללות יכולות כמו אישות הודעות, ניהול נושאים, ניהול חסימות, וכדומה, ולבסוף הרשאות מנהל ראשי כוללות יכולות כמו שינוי הרשאות, הגדרת תגי BBCode מותאמים אישית, ניהול פורומים, וכדומה. הרשאות של משתמש מומלץ לשנות במקרים נדירים, השיטה המועדפת היא הכנסת משתמשים לקבוצות וקביעת הרשאות הקבוצה.',
	...
	'ROLE_FORUM_NEW_MEMBER'		=> 'משתמש שנרשם לאחרונה',
	...
	'ROLE_USER_NEW_MEMBER'		=> 'משתמש שנרשם לאחרונה',
	...
	'SET_USERS_PERMISSIONS'			=> 'קבע הרשאות משתמשים',
	'SET_USERS_FORUM_PERMISSIONS'	=> 'קבע הרשאות פורום של משתמשים',
	...
	'USERS_NOT_ASSIGNED'			=> 'אין משתמש שנקבע לכלל זה',
