...
$lang = array_merge($lang, array(
	...
	'SYSTEM_TIMEZONE_EXPLAIN'			=> 'איזור זמן המוצג למשתמשים לא מחוברים (אורחים, בוטים). משתמשים מחוברים מגדירים את אזור הזמן שלהם במהלך ההרשמה ויכולים לשנות אותו מלוח הבקרה למשתמש.',
...
$lang = array_merge($lang, array(
	...
	'QUOTE_DEPTH_LIMIT_EXPLAIN'		=> 'כמות מירבית לציטוטים בתוך ציטוטים בהודעה. כאשר 0 הנו לא מוגבל.',
