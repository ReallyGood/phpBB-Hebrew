...
$lang = array_merge($lang, array(
	...
	'MAX_POST_FONT_SIZE_EXPLAIN'	=> 'גודל הגופן המרבי המורשה בהודעה. כאשר 0 הינו לא מוגבל.',
	'MAX_POST_IMG_HEIGHT'			=> 'גובה תמונה מרבי לכל הודעה',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> 'גובה מרבי של תמונה/קובץ פלאש בהודעות. כאשר 0 הינו לא מוגבל.',
	'MAX_POST_IMG_WIDTH'			=> 'רוחב תמונה מרבי לכל הודעה',
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> 'רוחב מרבי של תמונה/קובץ פלאש בהודעות. כאשר 0 הינו לא מוגבל.',
	'MAX_POST_URLS'					=> 'מספר קישורים מרבי לכל הודעה',
	'MAX_POST_URLS_EXPLAIN'			=> 'מספר מרבי של קישורים בהודעה. כאשר 0 הינו לא מוגבל.',
	...
	'SMILIES_LIMIT_EXPLAIN'			=> 'מספר מרבי של סמיילים בהודעה. כאשר 0 הינו לא מוגבל.',
...
$lang = array_merge($lang, array(
	...
	'MAX_SIG_FONT_SIZE_EXPLAIN'		=> 'גודל גופן מרבי המורשה בחתימות המשתמשים. כאשר 0 הינו לא מוגבל.',
	'MAX_SIG_IMG_HEIGHT'			=> 'גובה תמונה מרבי לחתימה',
	'MAX_SIG_IMG_HEIGHT_EXPLAIN'	=> 'גובה מרבי של תמונה/קובץ פלאש בחתימות המשתמשים. כאשר 0 הינו לא מוגבל.',
	'MAX_SIG_IMG_WIDTH'				=> 'רוחב תמונה מרבי לחתימה',
	'MAX_SIG_IMG_WIDTH_EXPLAIN'		=> 'רוחב מרבי של תמונה/קובץ פלאש בחתימות המשתמשים. כאשר 0 הינו לא מוגבל.',
	...
	'MAX_SIG_SMILIES_EXPLAIN'		=> 'מספר מרבי של סמיילים המורשה בחתימות המשתמשים. כאשר 0 הינו לא מוגבל.',
	'MAX_SIG_URLS'					=> 'מספר קישורים מרבי לחתימה',
	'MAX_SIG_URLS_EXPLAIN'			=> 'מספר מרבי של קישורים בחתימות המשתמשים. כאשר 0 הינו לא מוגבל.',
));
...
//	'ACC_USER_ADMIN'			=> 'משתמש + מנהל ראשי',
	...
	'REG_LIMIT_EXPLAIN'			=> 'מספר הנסיונות שמשתמשים יכולים לנסות לפתור את מבחן הבוט לפני שהם ינעלו בחוץ בחיבור זה.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_INCORRECT_USER_PASSWORD'	=> 'קישור לשרת LDAP נכשל עם המשתמש/הססמה שצויינו.',
	...
	'LDAP_USER_EXPLAIN'				=> 'השאר ריק לשימוש בגישה אנונימית. אם הוזן, phpBB3 תשתמש בשם הנבחן בנסיונות התחברות כדי למצוא את המשתמש הנכון, למשל <samp>uid=Username,ou=MyUnit,o=MyCompany,c=US</samp>. נדרש לשרתי תיקייה פעילים.',
...
$lang = array_merge($lang, array(
	...
	'MAX_LOGIN_ATTEMPTS'			=> 'מספר מרבי של נסיונות התחברות עבור כל שם משתמש',
