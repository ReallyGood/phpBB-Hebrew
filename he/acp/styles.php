...
$lang = array_merge($lang, array(
	...
	'EDIT_IMAGESET_EXPLAIN'				=> 'כאן אתה יכול לערוך תמונות אשר מרכיבות את ערכת התמונה. אתה יכול גם לבחור מימדים עבור התמונה. מימדים הם בגדר בחירה, ובחירה בהם עלולה לשנות מאפייני תצוגה בדפדפנים מסוימים. אי בחירה בהם יכולה להיות חיסכון מקום בבסיס הנתונים.',
