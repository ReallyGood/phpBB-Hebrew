...
$lang = array_merge($lang, array(
	...
	'PARENT_IS_LINK_FORUM'		=> 'הפורום הראשי שבחרת הנו פורום מקושר. פורומים מקושרים אינם יכולים להחזיק פורומים, אנא בחר פורום או קטגוריה אחרת שתיהיה הפורום הראשי שיחזיק פורום זה.',
