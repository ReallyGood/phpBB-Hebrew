...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'   => 'זוהי רשימת 10 המשתמשים האחרונים שנרשמו אשר חשבונם אינו פעיל. משתמשים אלו אינם פעילים בגלל שהפעלת חשבון דרך דוא"ל היתה מופעלת בהגדרות רישום משתמש ומשתמשים אלה עדיין לא הופעלו. בקישור למטה ניתן למצוא את הרשימה המלאה, שם תוכל להפעיל, למחוק משתמשים או לשלוח תזכורת דוא"ל אם תרצה.',
