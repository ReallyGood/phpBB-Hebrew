...
// Logs
$lang = array_merge($lang, array(
	'ACP_ADMIN_LOGS_EXPLAIN'	=> 'עמוד זה רושם את כל הפעולות אשר בוצעו על־ידי המנהלים הראשיים של המערכת. ניתן למיין לפי שם משתמש, תאריך, כתובת IP או פעולה. במידה שקיימות ההרשאות המתאימות, ניתן להסיר פעולות מסוימות או את מעקב הפעולות בשלמותו.',
	'ACP_CRITICAL_LOGS_EXPLAIN'	=> 'עמוד זה רושם את כל הפעולות אשר התבצעו על־ידי המערכת עצמה. מעקב הפעולות מספק מידע אשר יוכל לשמש לפתירת בעיות מסוימות, כגון אי־מסירת הודעות דואר אלקטרוני. ניתן למיין לפי שם משתמש, תאריך, כתובת IP או פעולה. במידה שקיימות ההרשאות המתאימות, ניתן להסיר פעולות מסוימות או את מעקב הפעולות בשלמותו.',
	'ACP_MOD_LOGS_EXPLAIN'		=> 'עמוד זה רושם את כל הפעולות אשר התבצעו בפורומים, נושאים והודעות וגם פעולות שבוצעו על משתמשים על־ידי מנהלים, לרבות חסימתם. ניתן למיין לפי שם משתמש, תאריך, כתובת IP או פעולה. במידה שקיימות ההרשאות המתאימות, ניתן להסיר פעולות מסוימות או את מעקב הפעולות בשלמותו.',
