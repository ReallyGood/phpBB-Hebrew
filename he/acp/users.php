...
$lang = array_merge($lang, array(
	...
	'CONFIRM_EMAIL_EXPLAIN'			=> 'אתה צריך לסמן את זה במידה ואתה מעוניין לשנות את הדואר אלקטרוני של המשתמש.',

	'DELETE_POSTS'			=> 'מחק הודעות',
	'DELETE_USER'			=> 'מחק משתמש',
	'DELETE_USER_EXPLAIN'	=> 'אנא שים לב שמחיקת משתמש הינה לתמיד ואין אפשרות לשיחזור.',
