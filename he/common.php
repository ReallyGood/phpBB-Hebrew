...
$lang = array_merge($lang, array(
	...
	'LOGIN_ERROR_PASSWORD'				=> 'ציינת ססמה שגוייה. בדוק את סיסמתך ונסה שנית. אם אתה ממשיך להתקל בבעיות צור קשר עם %sהמנהל הראשי של המערכת%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'לא היה ניתן להמיר את סיסמתך בעת עדכון מערכת זו. אנא %sבקש ססמה חדשה%s. אם אתה ממשיך להתקל בבעיות צור קשר עם %sהמנהל הראשי של המערכת%s.',
