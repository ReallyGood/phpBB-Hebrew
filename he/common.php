...
$lang = array_merge($lang, array(
	...
	'ERR_WATCHING'						=> 'שגיאה התרחשה בעת הנסיון להירשם.',
	...
	'LOGIN_ERROR_ATTEMPTS'				=> 'עברת את המספר המרבי המותר של נסיונות התחברות. בנוסף לשם המשתמש והססמה שלך אתה צריך לפתור את האנטי-בוט שמתחת.',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> 'אינך אומתת על־ידי Apache.',
	'LOGIN_ERROR_PASSWORD'				=> 'ציינת ססמה שגוייה. בדוק את ססמתך ונסה שנית. אם אתה ממשיך להתקל בבעיות צור קשר עם %sהמנהל הראשי של המערכת%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'לא היה ניתן להמיר את ססמתך בעת עדכון מערכת זו. אנא %sבקש ססמה חדשה%s. אם אתה ממשיך להתקל בבעיות צור קשר עם %sהמנהל הראשי של המערכת%s.',
	...
	'NOT_AUTHORISED'			=> 'אינך מורשה להכנס לאזור זה.',
